...
def main():
    ...
    with st.sidebar:
        ...
        **Status:** ✅ Ready
        ...
        st.markdown('<p style="font-size: 14px; margin: 0;"><b>Developer:</b> Partha Sarathi R</p>', unsafe_allow_html=True)
    ...
    st.markdown('<p style="text-align: center; font-size: 14px; color: #888; margin-top: 40px; padding: 20px;">Created by Partha Sarathi R</p>', unsafe_allow_html=True)
